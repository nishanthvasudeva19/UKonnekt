...
import com.seteam3.pages.Preferences;
import com.seteam3.pages.TimetableView;

public class ProfMainActivity extends FragmentActivity {
		...
		// Recycle the typed array
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				case R.id.actionLogout:
					passwordData.open();
					passwordData.changePassword("0");
					startActivity(new Intent(ProfMainActivity.this, LogIn.class));
	                finish();
				default:
